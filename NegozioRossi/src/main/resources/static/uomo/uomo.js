...
let getArticolo = (id) => {
    $.ajax({
        ...
        success: function(res){
            let ris = "";
            console.log(res);
            console.log(res[id-1].nome);
            console.log(res.prezzo);
            ris += `
            <div class="row">
                <div class="col-4">
                ...
                <div class="col-6">
                    ...
                    <button class="carrello-btn" data-id=${res[0].id} onClick="aggiungiAlCarrello(${{
                        nome: res[id-1].nome,
...
$(document).ready(function(){
    ...
    /* 
        CHIAMATA get DI UN ELEMENTO.
    
    function getArticolo(id){
        $.ajax({
            url: `http://localhost:8080/articoli/${id}`,
            type: 'GET',
            success: function(res){
                let ris = "";
                ris += `
                <div class="row">
                    <div class="col-4">
                        <div id="carouselExampleControls" class="carousel slide dettaglio" data-bs-ride="carousel">
                            <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="../prodotti/prodotto1.jpg" class="d-block w-100 img-fluid w3-image" width="600" height="400" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../prodotti/prodotto1.jpg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="../prodotti/prodotto1.jpg" class="d-block w-100" alt="...">
                            </div>
                    ...
                    <div class="col-6">
                        <div class="row mb-3">
                            <h3>Nome prodotto:${res.nome}</h3> 
                        </div>
                        <div class="row mb-3">
                            <h3>Prezzo: ${res.prezzo}</h3>
                        </div>
                        ...
                        <button class="carrello-btn" data-id=${id}>
                            <i class="fas fa-shopping-cart"></i>
                            aggiungi al carrello
                        </button>
                    </div>
    ...
    function getArticoli(res) {
        $.ajax({
            url: "http://localhost:8080/articoli?sesso=M",
            type: "GET",
            success: res => {
                let ris = "";
